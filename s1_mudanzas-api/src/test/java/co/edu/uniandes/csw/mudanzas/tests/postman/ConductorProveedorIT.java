 ...
 */
package co.edu.uniandes.csw.mudanzas.tests.postman;

import co.edu.uniandes.csw.mudanzas.dtos.CascaraDTO;
import co.edu.uniandes.csw.mudanzas.mappers.BusinessLogicExceptionMapper;
import co.edu.uniandes.csw.mudanzas.resources.RestConfig;
...
public class ConductorProveedorIT {
    
    private static final String COLLECTION = "ConductorProveedorResource-collection.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_mudanzas-api.war")//War del modulo api
